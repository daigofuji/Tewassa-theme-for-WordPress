			<footer role="contentinfo" class="footer">
				...
				<div id="inner-footer" class="wrap clearfix">
					<p class="footer-about">TEWASSAは東日本大震災被災地を長期的に手作りでサポートしていくボランティアグループです。<br/>TEWASSA is a long-term volunteer project devoted to Japan Earthquake and Tsunami relief through handmade arts+crafts.</p>
